...
export default class ChangePasswordPage extends React.Component {
  ...
  render() {
    ...
    // If they just changed a password and are not logged in
    ...
    // If the just changed a password and are logged in
    if (isPasswordChanged && isLoggedIn) {
      return (
        <div className="row justify-content-center">
          <div className="col-10 col-sm-7 col-md-5 col-lg-4">
        ...
        <div className="col-10 col-sm-7 col-md-5 col-lg-4">
          ...
          <AvForm onValidSubmit={this.handleValidSubmit}>
            ...
            <AvGroup>
              ...
              />
              <AvFeedback>Passwords must be at least eight characters long</AvFeedback>
            </AvGroup>
